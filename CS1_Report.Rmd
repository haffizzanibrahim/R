...
---
##set up environment
The R environment was set up using the most common package in R for data science which is Tidyverse, for general data modelling. Other than that, ggplot is used for visualization, lubridate to work with date and time, and readxl to read and import data in excel file type. The following code was run to load the library
